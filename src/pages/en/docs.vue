<template>
  <OortShEnLayout :show-footer="false">
...
import OortShEnLayout from '@/components/OortShEn/OortShEnLayout.vue'
...
useHead({
  title: 'OORT.sh Docs - Resource Center'
})

const HTML_BASE_PATH = '/resource-center-en/'
...
const mainTabs = [
  { name: 'explore', label: 'Explore', icon: iconExplore },
  { name: 'design', label: 'Design', icon: iconDesign },
  { name: 'develop', label: 'Develop', icon: iconDevelop },
  { name: 'distribution', label: 'Distribute', icon: iconDistribution },
  { name: 'promotion', label: 'Promote', icon: iconPromotion },
  { name: 'ecosystem', label: 'Ecosystem', icon: iconEcosystem },
  { name: 'support', label: 'Support', icon: iconSupport }
]

const developTabs = [
  { name: 'overview', label: 'Overview', icon: iconDevOverview },
  { name: 'devEnvironment', label: 'Dev Environment', icon: iconDevEnv },
  { name: 'aiStudio', label: 'OortCloud AI Studio', icon: iconAiStudio },
  { name: 'mobileTest', label: 'Test Tools', icon: iconTestTool },
  { name: 'devPower', label: 'Open Capabilities', icon: iconDevPower },
  { name: 'devDocs', label: 'Developer Docs', icon: iconDevDoc },
  { name: 'devTemplate', label: 'Templates', icon: iconDevTemplate },
  { name: 'download', label: 'Download Center', icon: iconDownload }
]

const distributionTabs = [
  { name: 'portal', label: 'Portal', icon: iconPortal },
  { name: 'android', label: 'Android', icon: iconAndroid },
  { name: 'ios', label: 'iOS', icon: iconIos },
  { name: 'harmony', label: 'HarmonyOS', icon: iconHarmony },
  { name: 'desktop', label: 'OortCloud Desktop', icon: iconDesktop },
  { name: 'axi', label: 'AxI', icon: iconAxi },
  { name: 'claw', label: 'OortClaw', icon: iconClaw },
  { name: 'web', label: 'PC Web', icon: iconWeb },
  { name: 'miniProgram', label: 'Mini Program', icon: iconMiniProgram },
  { name: 'h5', label: 'Mobile', icon: iconMobile }
]
